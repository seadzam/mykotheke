...
<section id="hero__blog__page" class="section">
    <div class="container">
        <div class="columns">
                    ...
                    <div class="headline__wrap">
                        <div class="date__elem">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.6 2.7H2.7C1.76112 2.7 1 3.46111 1 4.4V16.3C1 17.2389 1.76112 18 2.7 18H14.6C15.5389 18 16.3 17.2389 16.3 16.3V4.4C16.3 3.46111 15.5389 2.7 14.6 2.7Z" stroke="#BEBEBE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12.0498 1V4.4" stroke="#BEBEBE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M5.25 1V4.4" stroke="#BEBEBE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M1 7.8H16.3" stroke="#BEBEBE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
...
<section id="blog__single__page" class="section">
    <div class="container">
        <div class="columns">
