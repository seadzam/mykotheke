            ...
            <div class="column is-12">
                <div class="inner__wrap">
                    ...
                    <div class="headline__wrap">
                        ...
                        <h1 class="title">ALLE VITALPILZ-PRODUKTE</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="column is-4">
                <div class="sidebar__wrap">
                    <div class="sidebar__box">
                        <a href="/produkte/vitalpilz-extrakte" class="link__elem <?php echo ($current_page == '/produkte/vitalpilz-extrakte/') ? 'active' : '' ?>">
                            <span>Vitalpilz-Extrakte</span>
                        </a>
                        <?php
                            if ( is_product_category( array( 'vitalpilz-extrakte', 'essenzen', 'kapseln-und-pulver' ) ) ) { ?>
                                <a href="/produkte/vitalpilz-extrakte/essenzen" class="link__elem __submenu <?php echo ($current_page == '/produkte/vitalpilz-extrakte/essenzen/') ? 'active' : '' ?>">
                                ...
                                <a href="/produkte/vitalpilz-extrakte/kapseln-und-pulver" class="link__elem __submenu <?php echo ($current_page == '/produkte/vitalpilz-extrakte/kapseln-und-pulver/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            ...
                            <?php }
                        ?>
                        <a href="/produkte/ab-hof-vitalpilze" class="link__elem <?php echo ($current_page == '/produkte/ab-hof-vitalpilze/') ? 'active' : '' ?>">
                        ...
                        <?php
                            if ( is_product_category( array( 'ab-hof-vitalpilze', 'frisch-vom-hof', 'gewurze-trockenvleisch', 'vitalpilz-tee-kaffee' ) ) ) { ?>
                                <a href="/produkte/ab-hof-vitalpilze/frisch-vom-hof" class="link__elem __submenu <?php echo ($current_page == '/produkte/ab-hof-vitalpilze/frisch-vom-hof/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                ...
                                <a href="/produkte/ab-hof-vitalpilze/gewurze-trockenvleisch" class="link__elem __submenu <?php echo ($current_page == '/produkte/ab-hof-vitalpilze/gewurze-trockenvleisch/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                ...
                                <a href="/produkte/ab-hof-vitalpilze/vitalpilz-tee-kaffee" class="link__elem __submenu <?php echo ($current_page == '/produkte/ab-hof-vitalpilze/vitalpilz-tee-kaffee/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            ...
                            <?php }
                        ?>
                        <a href="/produkte/vitalpilz-kosmetik" class="link__elem <?php echo ($current_page == '/produkte/vitalpilz-kosmetik/') ? 'active' : '' ?>">
                            <span>Vitalpilz-Kosmetik</span>
                        </a>
                        <a href="/produkte/bio-dunger-ersatz" class="link__elem <?php echo ($current_page == '/produkte/bio-dunger-ersatz/') ? 'active' : '' ?>">
                        ...
                        <?php
                            if ( is_product_category( array( 'bio-dunger-ersatz', 'mykorrhiza-vitalpilz-granulat-bio', 'mykorrhiza-vitalpilz-losung-bio' ) ) ) { ?>
                                <a href="/produkte/bio-dunger-ersatz/mykorrhiza-vitalpilz-granulat-bio" class="link__elem __submenu <?php echo ($current_page == '/produkte/bio-dunger-ersatz/mykorrhiza-vitalpilz-granulat-bio/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                ...
                                <a href="/produkte/bio-dunger-ersatz/mykorrhiza-vitalpilz-losung-bio" class="link__elem __submenu <?php echo ($current_page == '/produkte/bio-dunger-ersatz/mykorrhiza-vitalpilz-losung-bio/') ? 'active' : '' ?>">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 7L17 12L12 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1 1V8C1 9.06087 1.42143 10.0783 2.17157 10.8284C2.92172 11.5786 3.93913 12 5 12H17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                            ...
                            <?php }
                        ?>
                        <a href="/produkte/komplementaere-produkte" class="link__elem <?php echo ($current_page == '/produkte/komplementaere-produkte/') ? 'active' : '' ?>">
                            <span>Komplementäre produkte</span>
                        </a>
                        <a href="/produkte/pilzbuecher-pilzliteratur" class="link__elem <?php echo ($current_page == '/produkte/pilzbuecher-pilzliteratur/') ? 'active' : '' ?>">
                            <span>Pilzbücher / Pilzliteratur</span>
                        </a>
                        <a href="/produkte/geschenkartikel" class="link__elem <?php echo ($current_page == '/produkte/geschenkartikel/') ? 'active' : '' ?>">
                            <span>Geschenkartikel</span>
                        </a>
                        <a href="/produkte/pet-produkte" class="link__elem <?php echo ($current_page == '/produkte/pet-produkte/') ? 'active' : '' ?>">
